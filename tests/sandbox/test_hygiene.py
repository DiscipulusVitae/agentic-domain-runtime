...
ALLOWLIST = {
    ...
    "tests/sandbox/bootstrap/test_cleanup_hardening.py":
        "T310+T317+T321+T322: comprehensive cleanup tests (31 tests).",
    "tests/sandbox/bootstrap/test_install_live_blockers.py":
        "T305+T322: env-var guard tests, nested envVar preservation.",
    "tests/sandbox/test_runtime.py":
        "T307.2+T318: webhook + sendMessage tests (27 tests).",
}
